 ...
 * @LastEditTime: 2023-10-24 12:01:18
...
vector<double> JacobiIteration(int equationN, vector<vector<double>> matrixA, vector<double> b, vector<double> initialX){
    int n = equationN;
...
int main(){
    ...
    vector<double> x = JacobiIteration(equationN, A, b, x0);
    // cout << "The solution of x is (" << x[0];
